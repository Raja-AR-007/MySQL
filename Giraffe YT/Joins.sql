...
DROP TABLE branch_supplier;
										-- Jions
                                        -- JOIN (General Join refered to as a 'Inner Join')
-- JOIN used to combine rows from two or more table based on related columns.
...
FROM employee
LEFT JOIN branch
ON employee.emp_id = branch.mgr_id;  -- left = right;
