...
DROP TABLE branch_supplier;
					               ...
					               -- Functions 'CUONT(), SUM(), AVG()', GROUP BY
								      -- COUNT()
-- COUNT() is used to count the number of values in the Colunms.
...
-- Find all the employee's average salary
SELECT AVG(salary)
FROM employee;

-- Find the all male employee's average salary for 
SELECT AVG(salary)
FROM employee
WHERE sex='M';

                                      -- SUM()
-- SUM() is used to add the values in the Column.
-- Find all the employee's sum of salary
SELECT SUM(salary)
FROM employee;

                                     -- GROUP BY
-- GROUP BY is used to seperate the values.
